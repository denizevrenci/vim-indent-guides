...
function! indent_guides#basic_highlight_colors()
  ...
  exe 'hi IndentGuidesEven guibg=' . l:gui_even . ' guifg=' . l:gui_odd . ' ctermbg=' . l:cterm_even . ' ctermfg=' . l:cterm_odd
  exe 'hi IndentGuidesOdd  guibg=' . l:gui_odd . ' guifg=' . l:gui_even . ' ctermbg=' . l:cterm_odd . ' ctermfg=' . l:cterm_even
endfunction
